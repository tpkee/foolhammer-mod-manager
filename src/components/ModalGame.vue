...
async function pickPath(field: 'gamePath' | 'steamWorkshopPath' | 'savesPath' | 'modsPath') {
  try {
...
function handleSubmit() {
  ...
  emit('save', {
    ...
    steamWorkshopPath: form.value.steamWorkshopPath || undefined,
    savesPath: form.value.savesPath || undefined,
    modsPath: form.value.modsPath || undefined,
  })
